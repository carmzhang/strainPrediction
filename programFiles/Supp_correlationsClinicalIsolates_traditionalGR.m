...
% phenotypic distances. The phenotype used here is the growth rate.
% (1) phage vs 100x
% (2) 10,000x vs 100x
% (3) 100x vs CAR
%
% Here, we also quantify correlation with a bramila-mantel test for a chosen
% growth condition and phylogeny. Choose the growth condition of interest
% in line 373.  Supplementary table 2.2.
%
